...
- **AGENTS.md**: If introducing new patterns or common mistakes
...
## Changed files
- List every file created or modified (relative paths from repo root)
- This list is used by the reviewer to scope its read — be complete and accurate
